...
0b. Use subagents to study `specs/*` to learn JTBD activities.
0c. Study @IMPLEMENTATION_PLAN.md (if present) to understand the plan so far.
0d. Use subagents to study `src/lib/*` to understand shared utilities & components.
